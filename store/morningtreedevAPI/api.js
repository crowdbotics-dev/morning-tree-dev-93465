...
function rest_auth_password_reset_confirm_create(payload) {
  return morningtreedevAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}
...
function rest_auth_registration_verify_email_create(payload) {
  return morningtreedevAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
